      ...
      <div className="h-full overflow-hidden pt-4">
            ...
            <div>
              <a className="flex items-center" href="/">
                <Image
                  ...
                  className=" rounded"
                  src="https://webosmotic.com/wp-content/themes/icw-webosmotic/assets/images/wo-logo-10-04-2024.svg"
                  alt="Webosmotic"
                  width={250}
                  height={250}
                  priority
        ...
        <div className=" backdrop-blur-[2px] h-[4rem] flex items-center">
          <footer className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 flex items-center justify-center gap-4 md:text-xl font-inter text-[#8a8a8e]">
            ...
            <a
              className="text-base font-semibold"
              href="https://webosmotic.com/contact-us/"
              target="_blank"
            >
              contact us
            </a>
